...
export default function App() {
  ...
  return (
    <SafeAreaView>
      ...
      {connect ? (
        <View>
          <Film titre="Pacman" des="un très bon film qui participe bien a l'effort général" q="2022" genre1="action" genre2="spatial" authorname="Pierre" img='https://media1.tenor.com/m/eY8Pkv7NrMQAAAAC/pixels-pac-man.gif' />
